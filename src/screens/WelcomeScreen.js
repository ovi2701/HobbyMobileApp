...
export default function WelcomeScreen() {
  ...
  return (
    <View className="flex-1 justify-center items-center space-y-10 bg-emerald-700">
      ...
      <View className="flex items-center space-y-2">
        ...
        <Text style={{fontSize: hp(2.5)}} className="font-medium text-white tracking-widest">
